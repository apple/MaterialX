    ...
    try
    {
        ...
        if (elem)
        {
            ...
            if (context.getShaderGenerator().getTarget() == mx::MslShaderGenerator::TARGET)
            {
                ...
                new ng::MessageDialog(this, ng::MessageDialog::Type::Information, "Saved Metal source: ",
...
void Viewer::loadShaderSource()
{
    try
    {
        ...
        {
            mx::FilePath sourceFilename = getBaseOutputPath();
            mx::FilePath pixelSourceFilename = sourceFilename.asString() + "_ps.metal";
            mx::FilePath vertexSourceFilename = sourceFilename.asString() + "_vs.metal";
...
void Viewer::renderFrame()
{
    ...
    [renderpassDesc.colorAttachments[0] setTexture:(id <MTLTexture>)metal_texture() ];
    ...
    {
        [MTL(renderCmdEncoder) setFragmentTexture:id<MTLTexture>(metal_texture()) atIndex:0];
...
mx::ImagePtr Viewer::getAmbientOcclusionImage(MaterialPtr material)
{
    ...
    mx::ImagePtr img = _imageHandler->acquireImage(aoFilename);
    return img;
}
